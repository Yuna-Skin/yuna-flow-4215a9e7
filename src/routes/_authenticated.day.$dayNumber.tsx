                      ...
                      <div className="flex items-start justify-between gap-3 p-4">
                        ...
                        {m.video_url && (
                          <button
                            ...
                            className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-primary/20 text-primary-foreground shadow-sm backdrop-blur-sm transition-transform hover:bg-primary/40 hover:scale-105 active:scale-95"
                          >
